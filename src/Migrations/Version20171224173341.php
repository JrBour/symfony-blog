 ...
 */
class Version20171224173341 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE blog ADD category_id INT DEFAULT NULL, CHANGE description description VARCHAR(255) NOT NULL');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE blog DROP category_id, CHANGE description description TEXT NOT NULL COLLATE utf8_unicode_ci');
    }
}
